...
class MainWindow:
    def __init__(self, root):
        ...
        self.entry_input.pack(fill=tk.X, padx=5, pady=5)

        self.pos_label = ttk.Label(root, text="Select word type:")
        self.pos_label.pack(padx=5, pady=5)
        self.pos_var = tk.StringVar()
        self.pos_combobox = ttk.Combobox(root, textvariable=self.pos_var, values=["Noun", "Verb", "Adjective", "Adverb"], state="readonly")
        self.pos_combobox.pack(fill=tk.X, padx=5, pady=5)
        ...
        self.info_checkbutton.pack(padx=5, pady=5)
